...
useEffect(()=>{
    ...
    apiServices.allQuiz(datas).then((data)=>{
        // console.log(data)
        setTimeout(()=>{
            setLoading(false)
        },1500)
 ...
 const changeStatus=(id,status)=>{
    ...
    apiServices.changeStatusQuiz(data).then((data)=>{
      // console.log(data)
      setTimeout(()=>{
          setLoading(false)
      },1000)
                    ...
                    <thead>
                        ...
                        {quiz?.map((element,index)=>(
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                <Link to={"/admin/view_quiz_ques/"+element?._id}>
                                    <button className="btn btn-outline-info me-4 rounded-pill">View</button>
                                </Link>
                                </td>
                                <td width="270px" >
                               
                                <Link to={"/admin/update_quiz/"+element?._id}>
